	...
	<div class="row clearfix">
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
					...
					<div class="body">
						<h4>Basic Fields (form-float)</h4><br>
						...
						<h4>Basic Fields (row-clearfix)</h4><br>
						<div class="row-clearfix form-group">
							<div class="col-sm-12">
								<input type="text" id="basic" class="form-control form-line" placeholder="basic"/>
								<label class="form-label"></label>
							</div>
							<div class="col-sm-12">
								<input type="text" id="disabled" class="form-control form-line" value="" placeholder="disabled" disabled/>
								<label class="form-label"></label>
							</div>
							<div class="col-sm-12">
								<input type="text" id="success" class="form-control form-line" value="" placeholder="success"/> 
								<label class="form-label"></label>
							</div>
							<div class="col-sm-12">
								<input type="text" id="warning" class="form-control form-line" value="" placeholder="warning" />
								<label class="form-label"></label>
							</div>
						</div><br>
						...
						<h4>Buttons</h4>
						<div class="">
							<a button type = "button" class="btn btn-primary m-t-15 waves-effect" href="#">Submit (Primary)</a>	
							<a button type = "button" class="btn btn-secondary m-t-15 waves-effect" href="#">Submit (Secondary)</a>	
							<a button type = "button" class="btn btn-tertiary m-t-15 waves-effect" href="#">Submit (Green)</a>	
						</div>
					</div>
				</div>
			</div>			
